...
Version 12 automatically scans both supported executable names when present:
...
If both executable names are present, v12 scans both automatically. No renaming
